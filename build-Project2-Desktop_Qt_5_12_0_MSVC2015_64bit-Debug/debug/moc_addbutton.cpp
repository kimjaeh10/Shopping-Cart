...
#include "../../Project2/Project2/addbutton.h"
...
QT_MOC_LITERAL(1, 10, 8), // "iChanged"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9) // "myClicked"

    },
    "AddButton\0iChanged\0\0myClicked"
};
...
void AddButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AddButton::*)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddButton::iChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddButton::iChanged(QObject * _t1)
{
